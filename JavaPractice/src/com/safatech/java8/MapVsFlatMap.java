...
public class MapVsFlatMap {
    ...
    public static void main(String[] args) {
        ...
        List<List<String>> phoneNumbers = customers.stream().map(customer -> customer.getPhoneNumber()).collect(Collectors.toList());
        System.out.println(phoneNumbers);

        /**
         * List<Customer> convert List<String> -> Data Transformation + Flattering
         * mapping : customer -> customer.getPhoneNumber(); one to many mapping
         */
